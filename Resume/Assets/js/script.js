...
document.getElementById('about-tag').style.top=ot+150+'px';

var ot2 = parseInt(document.getElementById('projects').offsetTop,10);
document.getElementById('project-tag').style.top=ot2+250+'px';

var ot3= parseInt(document.getElementById('links').offsetTop,10);
document.getElementById('link-tag').style.top=ot3+250+'px';
});
